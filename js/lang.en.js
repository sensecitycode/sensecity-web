lang = {
	...
	msg_subdomain_title:"en Τι συμβαίνει στην πόλη",
	msg_sub_text1:"en Δείτε με μια ματιά εδώ τι έχουν αναφέρει οι υπόλοιποι πολίτες και ποια είναι τα τελευταία συμβάντα στη πόλη!",
	msg_sub_text2:"en * Η απεικόνιση των κάδων απορριμάτων δεν συνάδει με οποιαδήποτε οριστική χωροθέτηση αυτών."
};
