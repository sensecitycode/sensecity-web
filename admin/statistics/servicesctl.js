                ...
                function (data) {           
                    ...
                    $("#search_btn").click("on", function () {
                        function dep_stats(department) {
                            $http.get($rootScope.Variables.APIADMIN + "/issue?city=" + $rootScope.Variables.city_name + "&startdate=" + $("#startdate").val() + "&enddate=" + $("#enddate").val() + "&status=IN_PROGRESS|RESOLVED&image_field=0&sort=-1&limit=500&includeAnonymous=1&resolution=FIXED|INVALID|DUPLICATED&departments=" + department).then(function (response) {
