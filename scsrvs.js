...
//    console.log("rootScope.Variables.APIURL ==================>>>>>>>>>>>>>>>>>>>>>> "+$rootScope.Variables.APIURL);
    ...
    return $resource($rootScope.Variables.APIADMIN+"/issue",
        {}, {
        update: {
          method: 'GET'
          // isArray: true
...
//    console.log("rootScope.Variables.APIURL ==================>>>>>>>>>>>>>>>>>>>>>> "+JSON.stringify($rootScope.Variables));
    if($rootScope.Variables.APIURL != ""){
    return $resource($rootScope.Variables.APIADMIN+"/feelings",
        {}, {
        update: {
          method: 'GET'
          // isArray: true
...
appServices.factory('DisplayLast6IssuesService', function ( $resource/*, APIEndPointService*/, $rootScope,$window) {
    // console.log("DisplayIssues");
    if($rootScope.Variables.APIURL != ""){
    return $resource( $rootScope.Variables.APIADMIN+'/issue?city='+$rootScope.Variables.city_name+'&startdate=2018-03-01&sort=-1&limit=6&list_issue=1&image_field=1',
        {}, {
        update: {
          method: 'GET'
          // isArray: true
...
appServices.factory('DisplayLast100IssuesService', function ( $resource/*, APIEndPointService*/, $rootScope) {
    // console.log("DisplayIssues");
    if($rootScope.Variables.APIURL != ""){
    return $resource( $rootScope.Variables.APIADMIN+'/issue?city='+ $rootScope.Variables.city_name+'&startdate=2018-03-01&sort=-1&limit=100&list_issue=1&image_field=1',
        {}, {
        update: {
          method: 'GET'
          // isArray: true
